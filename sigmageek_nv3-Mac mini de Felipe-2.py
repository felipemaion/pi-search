...
def merge_palindromes_file_threads(output_file, file_id, rules = ["Thread", "big_palindromes", "txt"]):
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"{datetime.now()} ERROR!! {e} traceback.format_exc(): {traceback.format_exc()}")
